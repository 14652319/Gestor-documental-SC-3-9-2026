...
print("\n" + "="*80)
print("CARGA COMPLETA: DIAN + ERP FINANCIERO + ACUSES")
print("="*80)
...
print(f"✓ Leídas {len(df_dian):,} filas")
...
# Procesar
print(f"\nProcesando {len(df_dian):,} registros...")
...
print(f"✓ {len(registros_dian):,} procesados")
...
print(f"✓ {insertados_dian:,} registros insertados")

raw_conn.commit()

# ==============================================================================
# TABLA 2: ERP FINANCIERO
# ==============================================================================

print("\n" + "-"*80)
print("CARGANDO TABLA ERP FINANCIERO")
print("-"*80)
...
print("="*80)
print(f"\nDIAN: {insertados_dian:,} registros")
print(f"ERP Comercial: (Ya cargado previamente)")
print(f"ERP Financiero: {insertados_fn:,} registros")
print()
