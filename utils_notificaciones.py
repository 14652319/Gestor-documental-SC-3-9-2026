            ...
            <div style="max-width: 800px; margin: 0 auto; background-color: white; border-radius: 12px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1); overflow: hidden;">
                ...
                <div style="padding: 30px;">
                    ...
                    <div style="text-align: center; margin: 30px 0;">
                        <a href="{os.getenv('APP_BASE_URL', 'http://192.168.11.205:8099')}/facturas-digitales/dashboard" 
...
Acceso al sistema: {os.getenv('APP_BASE_URL', 'http://192.168.11.205:8099')}/facturas-digitales/dashboard
