...
def api_check_nit():
    """
    Verifica si un NIT existe y retorna datos completos del tercero
    
    Respuesta mejorada:
    - exists: bool
    - tercero: {nit, razon_social, correo, celular, estado, fecha_registro, fecha_actualizacion, dias_antiguedad, requiere_actualizacion}
    """
    data = request.get_json(force=True, silent=True) or {}
    nit = data.get("nit", "").strip()
    ...
    if tercero:
        # 🆕 Calcular antigüedad de documentación
        ...
        if tercero.fecha_actualizacion:
            ...
            requiere_actualizacion = dias_antiguedad >= 365  # ✅ Bloqueado si >= 1 año
...
log_security("✅ SERVIDOR INICIANDO - Módulos HABILITADOS: Recibir Facturas, Relaciones, Archivo Digital, Causaciones, DIAN vs ERP, Monitoreo, Facturas Digitales")
