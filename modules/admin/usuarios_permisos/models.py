    ...
    MODULOS = {
        ...
        'recibir_facturas': {
            ...
            'acciones': {
                ...
                # Alias usados en routes.py (nombres reales verificados en BD)
                'cargar_facturas_temporales': {
                    'nombre': 'Cargar Facturas Temporales',
                    'descripcion': 'Ver y gestionar lista de facturas temporales cargadas',
                    'tipo': 'vista',
                    'critico': False
                },
                'consultar_facturas': {
                    'nombre': 'Consultar Facturas',
                    'descripcion': 'Listar y buscar facturas en el sistema',
                    'tipo': 'consulta',
                    'critico': False
                },
                'exportar_facturas': {
                    'nombre': 'Exportar Facturas',
                    'descripcion': 'Descargar facturas en formato Excel',
                    'tipo': 'exportacion',
                    'critico': False
                },
                'limpiar_todo': {
        ...
        'relaciones': {
            ...
            'acciones': {
                ...
                'rechazar_factura': {
                    'nombre': 'Rechazar Factura',
                    'descripcion': 'Rechazar una factura de una relación digital',
                    'tipo': 'accion',
                    'critico': True
                },
                'revertir_rechazo': {
                    'nombre': 'Revertir Rechazo',
                    'descripcion': 'Anular el rechazo de una factura',
                    'tipo': 'accion',
                    'critico': True
                }
            }
        ...
        'notas_contables': {
            ...
            'acciones': {
                ...
                # Alias usados en routes.py
                'cargar_documento': {
                    'nombre': 'Cargar Documento',
                    'descripcion': 'Subir nuevos documentos al archivo digital',
                    'tipo': 'carga',
                    'critico': False
                },
                'consultar_notas': {
                    'nombre': 'Consultar Notas',
                    'descripcion': 'Listar y buscar notas/documentos',
                    'tipo': 'consulta',
                    'critico': False
                },
                'editar_nota': {
                    'nombre': 'Editar Nota',
                    'descripcion': 'Modificar datos de una nota contable',
                    'tipo': 'edicion',
                    'critico': False
                },
                'eliminar_nota': {
                    'nombre': 'Eliminar Nota',
                    'descripcion': 'Eliminar una nota contable del sistema',
                    'tipo': 'eliminacion',
                    'critico': True
                },
                'descargar_nota': {
                    'nombre': 'Descargar Nota',
                    'descripcion': 'Descargar archivo de nota contable',
                    'tipo': 'descarga',
                    'critico': False
                },
                'visualizar_nota': {
                    'nombre': 'Visualizar Nota',
                    'descripcion': 'Ver en pantalla el PDF de una nota contable',
                    'tipo': 'vista',
                    'critico': False
                },
                'editar_documento': {
                    'nombre': 'Editar Documento',
                    'descripcion': 'Modificar metadatos de documento (empresa, tipo, centro)',
                    'tipo': 'edicion',
                    'critico': True
                },
                'exportar_excel': {
                    'nombre': 'Exportar a Excel',
                    'descripcion': 'Exportar listado de notas a Excel',
                    'tipo': 'exportacion',
                    'critico': False
                },
                'agregar_observacion': {
                    'nombre': 'Agregar Observación',
                    'descripcion': 'Añadir comentarios al historial de un documento',
                    'tipo': 'edicion',
                    'critico': False
                }
            }
        ...
        'causaciones': {
            ...
            'acciones': {
                ...
                'consultar_documentos': {
                    ...
                    'descripcion': 'Listar y aplicar filtros sobre documentos de causaciones',
                    'tipo': 'consulta',
                    'critico': False
                },
                'eliminar_archivo': {
                    'nombre': 'Eliminar Archivo',
                    'descripcion': 'Eliminar definitivamente un archivo de causaciones',
                    'tipo': 'eliminacion',
                    'critico': True
                }
            }
        ...
        'monitoreo': {
            ...
            'acciones': {
                ...
                # Alias usados en routes.py (monitoreo/routes.py)
                'consultar_alertas': {
                    'nombre': 'Consultar Alertas',
                    'descripcion': 'Ver alertas de seguridad e intentos de acceso sospechosos',
                    'tipo': 'consulta',
                    'critico': True
                },
                'consultar_logs': {
                    'nombre': 'Consultar Logs',
                    'descripcion': 'Leer archivos de log del sistema',
                    'tipo': 'consulta',
                    'critico': False
                },
                'configurar_sistema': {
                    'nombre': 'Configurar Sistema',
                    'descripcion': 'Modificar parámetros de configuración del monitoreo',
                    'tipo': 'configuracion',
                    'critico': True
                },
                'ejecutar_backups': {
                    'nombre': 'Ejecutar Backups',
                    'descripcion': 'Lanzar copias de seguridad del sistema',
                    'tipo': 'accion',
                    'critico': True
                },
                'monitorear_ips': {
                    'nombre': 'Monitorear IPs',
                    'descripcion': 'Ver IPs conectadas y actividad de red en tiempo real',
                    'tipo': 'consulta',
                    'critico': False
                },
                'monitorear_usuarios': {
                    'nombre': 'Monitorear Usuarios',
                    'descripcion': 'Ver sesiones activas y actividad de usuarios en tiempo real',
                    'tipo': 'consulta',
                    'critico': False
                }
            }
        ...
        'terceros': {
            'nombre': 'Terceros',
            'descripcion': 'Gestión de proveedores, clientes y terceros del sistema',
            'color': '#0e7490',  # cyan oscuro
            'icono': 'fas fa-address-book',
            'acciones': {
                'acceder_modulo': {
                    'nombre': 'Acceder al Módulo',
                    'descripcion': 'Acceso general al módulo de terceros',
                    'tipo': 'acceso',
                    'critico': False
                },
                'consultar': {
                    'nombre': 'Consultar Terceros',
                    'descripcion': 'Buscar y listar terceros registrados',
                    'tipo': 'consulta',
                    'critico': False
                },
                'crear': {
                    'nombre': 'Crear Tercero',
                    'descripcion': 'Registrar nuevos terceros en el sistema',
                    'tipo': 'creacion',
                    'critico': False
                },
                'editar': {
                    'nombre': 'Editar Tercero',
                    'descripcion': 'Modificar datos de terceros existentes',
                    'tipo': 'edicion',
                    'critico': True
                },
                'configurar': {
                    'nombre': 'Configurar Tercero',
                    'descripcion': 'Ajustar configuración avanzada de terceros',
                    'tipo': 'configuracion',
                    'critico': True
                },
                'gestionar_documentos': {
                    'nombre': 'Gestionar Documentos',
                    'descripcion': 'Administrar documentos asociados a terceros',
                    'tipo': 'gestion',
                    'critico': False
                }
            }
        ...
        'dian_vs_erp': {
            'nombre': 'DIAN vs ERP',
            'descripcion': 'Conciliación y gestión de facturas entre DIAN y sistema ERP',
            'color': '#b45309',  # ámbar oscuro
            'icono': 'fas fa-balance-scale',
            'acciones': {
                'acceder_modulo': {
                    'nombre': 'Acceder al Módulo',
                    'descripcion': 'Acceso general al módulo DIAN vs ERP',
                    'tipo': 'acceso',
                    'critico': False
                },
                'cargar_archivos': {
                    'nombre': 'Cargar Archivos',
                    'descripcion': 'Subir archivos DIAN o ERP para conciliación',
                    'tipo': 'carga',
                    'critico': False
                },
                'consultar_datos': {
                    'nombre': 'Consultar Datos',
                    'descripcion': 'Ver y filtrar datos de conciliación',
                    'tipo': 'consulta',
                    'critico': False
                },
                'exportar_datos': {
                    'nombre': 'Exportar Datos',
                    'descripcion': 'Descargar datos de conciliación en Excel',
                    'tipo': 'exportacion',
                    'critico': False
                },
                'enviar_correos': {
                    'nombre': 'Enviar Correos',
                    'descripcion': 'Enviar notificaciones por correo a proveedores',
                    'tipo': 'accion',
                    'critico': True
                },
                'configurar_smtp': {
                    'nombre': 'Configurar SMTP',
                    'descripcion': 'Modificar configuración del servidor de correo',
                    'tipo': 'configuracion',
                    'critico': True
                },
                'gestionar_usuarios_dian': {
                    'nombre': 'Gestionar Usuarios DIAN',
                    'descripcion': 'Administrar usuarios del sistema DIAN',
                    'tipo': 'gestion',
                    'critico': True
                },
                'sincronizar': {
                    'nombre': 'Sincronizar Datos',
                    'descripcion': 'Ejecutar sincronización entre DIAN y ERP',
                    'tipo': 'accion',
                    'critico': True
                },
                'eliminar_datos': {
                    'nombre': 'Eliminar Datos',
                    'descripcion': 'Borrar registros de conciliación (requiere token de confirmación)',
                    'tipo': 'eliminacion',
                    'critico': True
                },
                'ver_logs': {
                    'nombre': 'Ver Logs',
                    'descripcion': 'Consultar historial y logs del módulo DIAN vs ERP',
                    'tipo': 'consulta',
                    'critico': False
                },
                'gestionar_envios': {
                    'nombre': 'Gestionar Envíos',
                    'descripcion': 'Configurar y ejecutar envíos programados',
                    'tipo': 'gestion',
                    'critico': True
                },
                'reportes_dinamicos': {
                    'nombre': 'Reportes Dinámicos',
                    'descripcion': 'Generar reportes personalizados de conciliación',
                    'tipo': 'reporte',
                    'critico': False
                }
            }
        ...
        'sagrilaft': {
            'nombre': 'SAGRILAFT',
            'descripcion': 'Sistema de Autocontrol y Gestión del Riesgo de LA/FT',
            'color': '#7c3aed',  # púrpura
            'icono': 'fas fa-shield-alt',
            'acciones': {
                'acceder_modulo': {
                    'nombre': 'Acceder al Módulo',
                    'descripcion': 'Acceso general al módulo SAGRILAFT',
                    'tipo': 'acceso',
                    'critico': False
                },
                'listar_radicados': {
                    'nombre': 'Listar Radicados',
                    'descripcion': 'Ver todos los radicados SAGRILAFT pendientes',
                    'tipo': 'consulta',
                    'critico': False
                },
                'revisar_documentos': {
                    'nombre': 'Revisar Documentos',
                    'descripcion': 'Ver documentos de un radicado para revisión',
                    'tipo': 'vista',
                    'critico': False
                },
                'actualizar_estado_documento': {
                    'nombre': 'Actualizar Estado Documento',
                    'descripcion': 'Aprobar o rechazar documentos individuales',
                    'tipo': 'accion',
                    'critico': True
                },
                'actualizar_estado_radicado': {
                    'nombre': 'Actualizar Estado Radicado',
                    'descripcion': 'Cambiar estado global del radicado (aprobado/rechazado)',
                    'tipo': 'accion',
                    'critico': True
                },
                'exportar_radicados': {
                    'nombre': 'Exportar Radicados',
                    'descripcion': 'Descargar listado de radicados en Excel',
                    'tipo': 'exportacion',
                    'critico': False
                },
                'descargar_documentos': {
                    'nombre': 'Descargar Documentos',
                    'descripcion': 'Descargar ZIP con documentos de un radicado',
                    'tipo': 'descarga',
                    'critico': False
                }
            }
...
def crear_permisos_por_defecto_usuario(usuario_id, rol='usuario_basico'):
    ...
    if rol == 'administrador' or rol == 'admin':
        ...
        permisos_basicos = [
            ...
            # Terceros (acceso completo)
            ('terceros', 'acceder_modulo', True),
            ('terceros', 'consultar', True),
            ('terceros', 'crear', True),
            ('terceros', 'editar', True),
            ('terceros', 'configurar', True),
            ('terceros', 'gestionar_documentos', True),

            # DIAN vs ERP (acceso completo)
            ('dian_vs_erp', 'acceder_modulo', True),
            ('dian_vs_erp', 'cargar_archivos', True),
            ('dian_vs_erp', 'consultar_datos', True),
            ('dian_vs_erp', 'exportar_datos', True),
            ('dian_vs_erp', 'enviar_correos', True),
            ('dian_vs_erp', 'configurar_smtp', True),
            ('dian_vs_erp', 'gestionar_usuarios_dian', True),
            ('dian_vs_erp', 'sincronizar', True),
            ('dian_vs_erp', 'eliminar_datos', True),
            ('dian_vs_erp', 'gestionar_envios', True),
            ('dian_vs_erp', 'reportes_dinamicos', True),

            # SAGRILAFT (acceso completo)
            ('sagrilaft', 'acceder_modulo', True),
            ('sagrilaft', 'listar_radicados', True),
            ('sagrilaft', 'revisar_documentos', True),
            ('sagrilaft', 'actualizar_estado_documento', True),
            ('sagrilaft', 'actualizar_estado_radicado', True),
            ('sagrilaft', 'exportar_radicados', True),
            ('sagrilaft', 'descargar_documentos', True)
        ]
    elif rol == 'contador':
        # Contador: Acceso a módulos contables
        permisos_basicos = [
            ...
            # DIAN vs ERP (acceso operativo)
            ('dian_vs_erp', 'acceder_modulo', True),
            ('dian_vs_erp', 'consultar_datos', True),
            ('dian_vs_erp', 'exportar_datos', True),

            # SAGRILAFT (acceso operativo)
            ('sagrilaft', 'acceder_modulo', True),
            ('sagrilaft', 'listar_radicados', True),
            ('sagrilaft', 'revisar_documentos', True)
        ]
        ...
        permisos_basicos = [
            ...
            # DIAN vs ERP (solo consulta)
            ('dian_vs_erp', 'acceder_modulo', True),
            ('dian_vs_erp', 'consultar_datos', True),

            # SAGRILAFT (solo consulta)
            ('sagrilaft', 'acceder_modulo', True),
            ('sagrilaft', 'listar_radicados', True)
        ]
    else:
        ...
        permisos_basicos = [
            ...
            # Terceros (sin acceso)
            ('terceros', 'acceder_modulo', False),

            # DIAN vs ERP (sin acceso)
            ('dian_vs_erp', 'acceder_modulo', False),

            # SAGRILAFT (sin acceso)
            ('sagrilaft', 'acceder_modulo', False)
        ]
